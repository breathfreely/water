    ...
    <body>
        <div class="bgintor">               
            <div class="listintor">
                ...
                <div class="header1"><img src="/academic/Public/images/square.gif" width="6" height="6" alt="" />
                    <span>位置：个人管理 －&gt; <strong>基本信息</strong></span>
                </div>  
                <form class="form-horizontal" action="do_modify_pass" method="post">
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">输入密码</label>
                    <div class="col-sm-2">
                      <input type="password" name="password" class="form-control" id="inputEmail3" placeholder="输入密码">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">确认密码</label>
                    <div class="col-sm-2">
                      <input type="password" name="password2" class="form-control" id="inputPassword3" placeholder="确认密码">
                    </div>
                  </div>
                  <div class="form-group">
