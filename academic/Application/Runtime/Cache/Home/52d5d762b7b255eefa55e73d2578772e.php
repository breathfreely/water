        ...
        <div class="bgintor">               
            <div class="listintor">
                ...
                <div class="header1"><img src="/academic/Public/images/images/square.gif" width="6" height="6" alt="" />
                    <span>位置：学院管理 －&gt; <strong>所有学院</strong></span>
                </div>
                <div class="pagination"><?php echo ($page); ?></div>                
                <!--<div class="pagination pagination-large"><?php echo ($page); ?></div> 大号数字样式-->                     
                <div>
                <table class="table table-hover table-bordered">
                    <tr><td class="text-center">学院编号</td><td class="text-center">学院名</td><td class="text-center">操作</td></tr>
                    <?php if(is_array($result)): foreach($result as $key=>$vo): ?><tr value="<?php echo ($vo["id"]); ?>"><td class="text-center"><?php echo ($vo["id"]); ?></td><td class="text-center"><?php echo ($vo["name"]); ?></td><td class="text-center"><a href="<?php echo U('admin/modify_depart');?>?id=<?php echo ($vo["id"]); ?>"  class="modify">修改</a>|
                            <a href="javascript:void(0)" class="delete">删除</a>|
                            <a href="<?php echo U('admin/d_class_list');?>?id=<?php echo ($vo["id"]); ?>">班级管理</a>|
                            <a href="<?php echo U('admin/d_class_add');?>?id=<?php echo ($vo["id"]); ?>">添加班级</a></td>
    ...
    $(function(){
        $(".delete").click(function(){
            if(confirm("确认删除")){
                ...
                var url="<?php echo U('admin/delete_depart');?>"+"?id="+id;
