        ...
        <div class="bgintor">               
            <div class="listintor">
                ...
                <div class="header1"><img src="/academic/Public/images/square.gif" width="6" height="6" alt="" />
                    <span>位置：课程管理 －&gt; <strong>修改课程</strong></span>
                </div>  
                <form class="form-horizontal" action="do_modify_course" method="post">
                  <div class="form-group">
                    <input type="hidden" name="id" value="<?php echo ($result['id']); ?>">
                    <label for="inputEmail3" class="col-sm-2 control-label">课程名</label>
                    <div class="col-sm-2">
                      <input type="text" name="name" class="form-control" id="inputEmail3" placeholder="请输入课程名" value="<?php echo ($result['name']); ?>">
                    </div>
                  </div>
                  <div class="form-group">
