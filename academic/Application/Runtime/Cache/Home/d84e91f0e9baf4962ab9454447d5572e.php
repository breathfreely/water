        ...
        <div class="bgintor">               
            <div class="listintor">
                ...
                <div class="header1"><img src="/academic/Public/images/images/square.gif" width="6" height="6" alt="" />
                    <span>位置：学院管理 －&gt; <strong><?php echo ($data["name"]); ?></strong>－&gt; <strong>所有班级</strong></span>
                </div>
                <div class="pagination"><?php echo ($page); ?></div>                
                <!--<div class="pagination pagination-large"><?php echo ($page); ?></div> 大号数字样式-->                     
                <div>
                <table class="table table-hover table-bordered">
                    <tr><td class="text-center">班级编号</td><td class="text-center">班级名</td><td class="text-center">班级人数</td><td class="text-center">年级</td><td class="text-center">操作</td></tr>
                    <?php if(is_array($result)): foreach($result as $key=>$vo): ?><tr value="<?php echo ($vo["id"]); ?>">
                            ...
                            <td class="text-center">
                                <a href="<?php echo U('admin/modify_course');?>?id=<?php echo ($vo["id"]); ?>"  class="modify">修改</a>|
